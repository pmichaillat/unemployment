### Unemployment: Fall 2024 Syllabus
...
+ Before Wednesday 2 October: videos in [Introduction](https://pascalmichaillat.org/c1/#introduction)
+ Before Wednesday 9 October: videos in [Labor market facts and matching function](https://pascalmichaillat.org/c1/#labor-market-facts-and-matching-function)
+ Before Wednesday 16 October: videos in [Matching model of the labor market](https://pascalmichaillat.org/c1/#matching-model-of-the-labor-market)
+ Before Wednesday 23 October: videos in [Wage functions](https://pascalmichaillat.org/c1/#wage-functions)
+ Before Wednesday 30 October: videos in [Unemployment fluctuations](https://pascalmichaillat.org/c1/#unemployment-fluctuations)
...
+ Before Monday 7 October: main readings in [Introduction](https://pascalmichaillat.org/c1/#introduction)
+ Before Monday 14 October: main readings in [Labor market facts and matching function](https://pascalmichaillat.org/c1/#labor-market-facts-and-matching-function)
+ Before Monday 21 October: main readings in [Matching model of the labor market](https://pascalmichaillat.org/c1/#matching-model-of-the-labor-market)
+ Before Monday 28 October: main readings in [Wage functions](https://pascalmichaillat.org/c1/#wage-functions)
+ Before Monday 4 November: main readings in [Unemployment fluctuations](https://pascalmichaillat.org/c1/#unemployment-fluctuations)
+ Before Wednesday 13 November: main readings in [Frictional and rationing unemployment](https://pascalmichaillat.org/c1/#frictional-and-rationing-unemployment) (there is no class on Monday 11 November as [it is a university holiday](https://registrar.ucsc.edu/calendar/key-dates/index.html))
+ Before Monday 18 November: main readings in [Efficient unemployment and unemployment gap](https://pascalmichaillat.org/c1/#efficient-unemployment-and-unemployment-gap)
+ Before Monday 25 November: main readings in [Labor-demand policies](https://pascalmichaillat.org/c1/#labor-demand-policies)
+ Before Monday 2 December: main readings in [Unemployment insurance](https://pascalmichaillat.org/c1/#unemployment-insurance)
...
+ Monday 14 October/Wednesday 16 October: quizzes on [Labor market](https://pascalmichaillat.org/v5.pdf) and [Matching function](https://pascalmichaillat.org/v6.pdf)
+ Monday 21 October/Wednesday 23 October: quizzes on [Matching model of the labor market](https://pascalmichaillat.org/v7.pdf)
+ Monday 28 October/Wednesday 30 October: quizzes on [Wage functions](https://pascalmichaillat.org/v8.pdf)
...
+ Wednesday 11 December at noon: final paper due [by email](mailto:mbessari@ucsc.edu)
...
It is fine to propose several possible projects if you are unsure. Presentation slides must be written in LaTeX and compiled to a PDF. Slides should be submitted [to Mariana by email](mailto:mbessari@ucsc.edu) before the presentation.
...
Presentation slides must be written in LaTeX and compiled to a PDF. Slides should be submitted [to Mariana by email](mailto:mbessari@ucsc.edu) before the presentation.
