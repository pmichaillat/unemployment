...
+ [Book chapters](https://github.com/pmichaillat/unemployment/tree/main/books) – The folder contains book chapters assigned as reading that may be hard to find otherwise.
+ [Section material](https://github.com/pmichaillat/unemployment/tree/main/sections) – The folder contains material from sections.
+ [Lecture material](https://github.com/pmichaillat/unemployment/tree/main/lecture%20notes) - The folder contains notes from lectures initiated from students' questions.
